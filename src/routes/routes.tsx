...
import ActivityLogsManagement from "../pages/AdminPages/activity/ActivityLogsManagement";
...
const adminRoutes: Route[] = [
  ...
  { path: "/admin-activity-logs", name: "Activity Logs", element: <ActivityLogsManagement /> },
